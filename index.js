...
import { initGamepadNav } from './core/gamepadNav.js?v=3';
...
worldManager.register('2', () => import('./worlds/world-01-teatro.js?v=23').then(m => m.default));
...
worldManager.register('6', () => import('./worlds/world06.js?v=17').then(m => m.default));
worldManager.register('7', () => import('./worlds/world07.js?v=6').then(m => m.default));
