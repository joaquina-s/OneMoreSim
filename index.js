...
import { bubblepicking } from './worlds/world09.js?v=6';
...
worldManager.register('3', () => import('./worlds/world-02-array3d.js?v=40').then(m => m.default));
worldManager.register('4', () => import('./worlds/world-03-tunnel.js?v=11').then(m => m.default));
