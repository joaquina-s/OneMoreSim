...
worldManager.register('2', () => import('./worlds/world-01-teatro.js?v=8').then(m => m.default));
worldManager.register('3', () => import('./worlds/world-02-array3d.js?v=37').then(m => m.default));
worldManager.register('4', () => import('./worlds/world-03-tunnel.js?v=5').then(m => m.default));
