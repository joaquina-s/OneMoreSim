...
import { bubblepicking } from './worlds/world09.js';
...
worldManager.register('3', () => import('./worlds/world-02-array3d.js?v=36').then(m => m.default));
worldManager.register('4', () => import('./worlds/world-03-tunnel.js?v=4').then(m => m.default));
